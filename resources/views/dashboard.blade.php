...
<body>
    ...
    <div class="filter">
        <div class="filterBox container-xxl mx-auto">
            <form method="POST" action="{{ route('getAveragePage') }}" acenctype="multipart/form-data" class="d-flex align-items-end row g-4 p-3">
                @csrf
                ...
                <div class="col-md-2" style="flex: 0 0 20%;">
                    ...
                    <input type="text" class="form-control" id="activity" placeholder="Tulis aktivitas.." name="activity">
                </div>
                <div class="col-md-2" style="flex: 0 0 20%;">
                    <label for="alergi" class="form-label">Alergi</label>
                    <select class="form-control" id="alergi" name="alergi" data-placeholder="Alergi" required multiple>
                    </select>
                </div>
                <div class="col-md-2" style="flex: 0 0 20%;">
                    <label for="kandungan" class="form-label">Kandungan</label>
                    <select class="form-control" id="kandungan" name="kandungan" data-placeholder="Kandungan" required multiple>
                    </select>
                </div>
                <div class="col-md-2" style="flex: 0 0 20%;">
